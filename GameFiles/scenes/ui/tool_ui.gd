...
const TOOL_TEXTURES = {
	Enum.Tool.AXE: preload("res://assets/plants/icons/axe.png"),
	Enum.Tool.HOE: preload("res://assets/plants/icons/hoe.png"),
	Enum.Tool.WATER: preload("res://assets/plants/icons/water.png"),
	Enum.Tool.SWING: preload("res://assets/plants/icons/sword.png"),
